...
def get_pie_chart(entered_site):
    ...
    # return the outcomes piechart for a selected site
        ...
        class_count = filtered_df.groupby('class').count()
...
def get_scatter_chart(entered_site, payload):
    MinEnd, MaxEnd = payload
    slide=(spacex_df['Payload Mass (kg)'] > MinEnd) & (spacex_df['Payload Mass (kg)'] < MaxEnd)
    payload_df=spacex_df[slide]
    if entered_site == 'ALL':
        fig = px.scatter(payload_df, x="Payload Mass (kg)", 
        y="class",
        color="Booster Version Category",
        hover_data=['Booster Version'],
        title='Success Launches by Payload Mass Range')
        return fig
    else:
    # return the outcomes scatter chart for a selected site
        ...
        color="Booster Version Category",
        hover_data=['Booster Version'],
        title='Success Launches by Payload Mass in Selected Site')
        return fig
